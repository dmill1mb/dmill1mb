...
Below is a five-part portfolio built end-to-end in Azure, covering the core pillars of enterprise IT operations: **identity → network visibility → log aggregation → process → vulnerability management.**

---

## 🛠️ Tech Stack

`Azure` `Windows Server` `Active Directory` `Wireshark` `Splunk` `ServiceNow` `Nessus` `PowerShell` `Linux`
...
📱 **Phone:** (501) 502-3477
✉️ **Email:** millersdemarcus@gmail.com
